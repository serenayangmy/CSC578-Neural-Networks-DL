...
class Network(object):
    ...
    def __init__(self, sizes, cost=CrossEntropyCost, act_hidden=Sigmoid,
        ...
        self.sizes = sizes
        # definted hidden layers
        self.hidden_layers = self.sizes[1:-1]  
    ...
    def set_parameters(self, cost=QuadraticCost, act_hidden=Sigmoid,
        ...
        #if cost function is Tanh, change to QuadraticCost and print warning
    ...
    def feedforward(self, a):
        ...
        for b, w in zip(self.biases[:-1], self.weights[:-1]):
            ...
            # get the activation for the last hidden layer
            # get the activations for hidden layer
        ...
        for j in range(epochs):
            ...
            if self.dropoutpercent != 0.0:
                ...
                for i in range(len(self.hidden_layers)):
                    mask = np.random.binomial(1, (1 - self.dropoutpercent),
                                              size=self.hidden_layers[i])/(1 - self.dropoutpercent)
    ...
    def backprop(self, x, y):
        ...
        # apply dropout into the hidden layer
        if self.dropoutpercent != 0.0:
            for i in range(len(self.hidden_layers)):
